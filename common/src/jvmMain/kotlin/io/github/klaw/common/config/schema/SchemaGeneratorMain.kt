...
private val ENGINE_OVERRIDES =
    mapOf(
        ...
        ".httpRetry.maxRetries" to buildJsonObject { put("minimum", 0) },
        ".httpRetry.requestTimeoutMs" to buildJsonObject { put("exclusiveMinimum", 0) },
        ".httpRetry.initialBackoffMs" to buildJsonObject { put("exclusiveMinimum", 0) },
        ".httpRetry.backoffMultiplier" to buildJsonObject { put("minimum", 1.0) },
        ".files.maxFileSizeBytes" to buildJsonObject { put("exclusiveMinimum", 0) },
        ".memory.autoRag.topK" to buildJsonObject { put("exclusiveMinimum", 0) },
        ".memory.autoRag.maxTokens" to buildJsonObject { put("exclusiveMinimum", 0) },
        ".memory.autoRag.relevanceThreshold" to buildJsonObject { put("exclusiveMinimum", 0.0) },
        ".memory.autoRag.minMessageTokens" to buildJsonObject { put("exclusiveMinimum", 0) },
        ".hostExecution.askTimeoutMin" to buildJsonObject { put("minimum", 0) },
