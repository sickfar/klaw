...
class SocketFactory {
    ...
    fun engineOutboundBuffer(): EngineOutboundBuffer {
        logger.debug { "Creating EngineOutboundBuffer at ${KlawPaths.engineOutboundBuffer}" }
        return EngineOutboundBuffer(KlawPaths.engineOutboundBuffer)
    }
    ...
    fun engineSocketServer(
        ...
        return EngineSocketServer(
            KlawPaths.enginePort,
            handler,
