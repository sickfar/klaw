...
| File | Description |
|------|-------------|
| `gateway.json` | Gateway configuration: channels, tokens, allowedChats, commands |
...
- Generated by background compaction (post-MVP feature)
...
- ONNX model files (~120 MB for multilingual-e5-small) downloaded from HuggingFace
