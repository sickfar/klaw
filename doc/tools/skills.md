...
Skills with missing or incomplete frontmatter are silently skipped during discovery. Use `/skills validate` (chat) or `klaw doctor` (CLI) to check for invalid skill directories.
